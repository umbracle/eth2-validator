...
// Hash: 30039231bc86c645f4c8781113c300e9f1dcb26cd32c6150951cdc3636c8fab6
package structs
...
func (s *SignedBeaconBlockAltair) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Signature'
	if size := len(s.Signature); size != 96 {
		err = ssz.ErrBytesLengthFn("SignedBeaconBlockAltair.Signature", size, 96)
		return
	}
	dst = append(dst, s.Signature...)
...
func (b *BeaconBlockAltair) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'ParentRoot'
	if size := len(b.ParentRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("BeaconBlockAltair.ParentRoot", size, 32)
		return
	}
	dst = append(dst, b.ParentRoot...)
	...
	// Field (3) 'StateRoot'
	if size := len(b.StateRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("BeaconBlockAltair.StateRoot", size, 32)
		return
	}
	dst = append(dst, b.StateRoot...)
...
func (c *ContributionAndProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(c.SelectionProof); size != 96 {
		err = ssz.ErrBytesLengthFn("ContributionAndProof.SelectionProof", size, 96)
		return
	}
...
func (s *SignedContributionAndProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Signature'
	if size := len(s.Signature); size != 96 {
		err = ssz.ErrBytesLengthFn("SignedContributionAndProof.Signature", size, 96)
		return
	}
	dst = append(dst, s.Signature...)
